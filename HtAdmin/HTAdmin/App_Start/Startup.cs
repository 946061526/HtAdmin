...
namespace HTAdmin
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<AdminRoleManager>(AdminRoleManager.Create);
            app.CreatePerOwinContext<AdminSignInManager>(AdminSignInManager.Create);

            app.CreatePerOwinContext<AdminPermissionManager>(AdminPermissionManager.Create);
            app.CreatePerOwinContext<AdminOperLogManager>(AdminOperLogManager.Create);
            app.CreatePerOwinContext<AdminLoginHistoryManager>(AdminLoginHistoryManager.Create);
